...
(function($) {
	var lis = document.querySelectorAll('.clock-t');
	var point = document.querySelectorAll('.clock-p');
	console.log(lis);
	...
	function fnMove(obj,src) {
		...
		pics[0].src = './static/images/clock/'+obj.t+'.png';
		obj.style.top = 0;
		pics[1].src = './static/images/clock/'+src+'.png';
		mTween(obj,{top: -100});
	}
	...
	function swinkle(onOff) {
		...
		for(var i=0; i<point.length; i++){
			point[i].src = './static/images/clock/'+src+'.png';
		}
	}
})(jQuery);
